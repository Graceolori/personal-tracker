...
USER_EMAIL = "golori84@gmail.com"
PARTNER_EMAIL = "martinsfm3000@gmail.com"

# Gmail SMTP (sender)
SENDER_EMAIL = "golori84@gmail.com"
EMAIL_PASSWORD = os.getenv("TRACKER_EMUOBO_EMAIL_PASSWORD")
...
def send_notification(user_name, today, activity):
    ...
    if not EMAIL_PASSWORD:
        print("Missing environment variable: TRACKER_EMUOBO_EMAIL_PASSWORD")
        raise SystemExit(1)
